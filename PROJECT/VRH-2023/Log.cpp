...
namespace Log
{
...

	{
		...
		while (wcslen(*ptr))																																																																//wcslen () возвращает длину заданной широкой строки
		{
			...
			wcstombs_s(&charsConverted, out, *ptr, PARM_MAX_SIZE);																																																															//Преобразует последовательность расширенных символов в соответствующую / последовательность многобайтовых символов 1-ый аргумент: Размер в байтах преобразованной строки, включая нулевой терминатор 2-
