...
namespace Error
{
	...
	*/
	ERROR errors[ERROR_MAX_ENTRY] =																																																															  //таблица ошибок
	{
		...
		ERROR_ENTRY(208,"[Лексическая] Значение не входит в диапозон допустимых значений типа integer"),
		ERROR_ENTRY(209,"[Лексическая] Переменная называется именем функции"),
		ERROR_ENTRY(210,"[Лексическая] Максимальный размер литерала line 255 символа"),
		...
		ERROR_ENTRY(507,"[Cемантическая] Ошибка в параметрах функции abs()"),
		ERROR_ENTRY(508,"[Cемантическая] Попытка сравнения операндов не типа integer"),
		...
		ERROR_ENTRY(511,"[Cемантическая] Ошибка в параметрах цикла cycle()"),
		ERROR_ENTRY(512,"[Cемантическая] Переменной одного типа, нельзя присвоить значение другого типа"),
		ERROR_ENTRY(513,"[Cемантическая] Ошибка при манипуляции операциями для строк"),
		ERROR_ENTRY(514,"[Семантическая] Значение типа line не может быть пустым"),
